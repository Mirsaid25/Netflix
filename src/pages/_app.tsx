            ...
            sessionId !== undefined ? 
                ...
                (
                    <div className='w-full flex flex-col items-center justify-center h-screen'>
                        <Link href={`https://www.themoviedb.org/authenticate/${token}?redirect_to=http://localhost:3000/`} className="">
                            <div className="text-white py-[5%] px-[15%]  bg-[#3657CB] rounded-[10px]">Потвердить токен</div>
                        </Link> 
