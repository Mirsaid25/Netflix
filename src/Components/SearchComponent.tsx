  ...
  return (
    <div className='flex items-center justify-between border-b-2 pb-10 bg-[#1E2538] border-[#3B486B]'>
        <div className='flex items-center gap-10'>
            <img src={data?.backdrop_path !== null ? `https://www.themoviedb.org/t/p/w220_and_h330_face/${data?.backdrop_path}` : "/image/[indexId]/posterError.svg"} alt=""  className='h-[150px] w-[90px] rounded-md'/>
